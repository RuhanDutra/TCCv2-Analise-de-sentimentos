...
RSpec.describe "/avaliacoes", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      Avaliacao.create! valid_attributes
      get avaliacoes_url
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Avaliacao" do
        expect {
          post avaliacoes_url, params: { avaliacao: valid_attributes }
        }.to change(Avaliacao, :count).by(1)
      end

      it "redirects to the created avaliacao" do
        post avaliacoes_url, params: { avaliacao: valid_attributes }
        expect(response).to redirect_to(avaliacao_url(Avaliacao.last))
      end
    end

    context "with invalid parameters" do
      it "does not create a new Avaliacao" do
        expect {
          post avaliacoes_url, params: { avaliacao: invalid_attributes }
        }.to change(Avaliacao, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested avaliacao" do
        avaliacao = Avaliacao.create! valid_attributes
        patch avaliacao_url(avaliacao), params: { avaliacao: new_attributes }
        avaliacao.reload
      ...
      it "redirects to the avaliacao" do
        ...
        patch avaliacao_url(avaliacao), params: { avaliacao: new_attributes }
        avaliacao.reload
        expect(response).to redirect_to(avaliacao_url(avaliacao))
      end
    end
    ...
    context "with invalid parameters" do
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        avaliacao = Avaliacao.create! valid_attributes
        patch avaliacao_url(avaliacao), params: { avaliacao: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
    end
  end
